...
const images = ["src/assets/swiperimg/1.jpg"];
  const texts = [
...
rgbKineticSlider = new rgbKineticSlider({
    ...
    backgroundDisplacementSprite: 'src/assets/swiperimg/1.jpg', // slide displacement image 
    cursorDisplacementSprite: 'src/assets/swiperimg/1.jpg', // cursor displacement image
